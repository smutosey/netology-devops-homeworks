...
locals {
  ...
  k8s_version   = "1.28" # Desired version of Kubernetes. For available versions, see the documentation main page: https://cloud.yandex.com/en/docs/managed-kubernetes/concepts/release-channels-and-updates.
  sa_name       = "k8s-nedorezov" # Service account name. It must be unique in a cloud.
  registry_name = "gitlab-registry" # Container Registry name.
